        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => {
            ...
            return (
              ...
              >
                {/* Timeline dot */}
                <div className={`absolute left-4 w-6 h-6 rounded-full bg-[#F97316] border-4 border-[#FFF7ED] z-10 shadow-lg shadow-[#FDBA74]/50 ${
                  isLeft ? "md:left-1/2 md:translate-x-[calc(-50% - 2px)]" : "md:left-1/2 md:translate-x-[calc(50% + 2px)]"
                }`}></div>

                {/* Experience card */}
                <div className={`bg-white rounded-xl p-6 shadow-xl border border-gray-100/80 max-w-md w-full transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] ml-10 md:ml-0 ${
                  isLeft ? "md:mr-auto md:ml-6" : "md:ml-auto md:mr-6 md:order-first"
                }`}
                  whileHover={{ y: -5 }}
                >
